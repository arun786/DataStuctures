...
public class check_bracketsTest {
    ...
    public void checkBalancePositiveScenario() {
        ...
        str = "}";
        assertEquals(check_brackets.checkBalance(str), "1"); //done

        str = "{}(){";
        assertEquals(check_brackets.checkBalance(str), "5"); //done
